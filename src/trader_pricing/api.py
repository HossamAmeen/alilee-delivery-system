...
from trader_pricing.serializers import (
    ListTraderDeliveryZoneSerializer,
    TraderDeliveryZoneSerializer,
)
...
class TraderDeliveryZoneViewSet(BaseViewSet):
    ...
    queryset = TraderDeliveryZone.objects.order_by("-id").select_related(
        "trader", "delivery_zone"
    )
